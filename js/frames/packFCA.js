...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	autoFitArt();
	//set symbol bounds
	card.setSymbolBounds = {x:0.91, y:0.5839, width:0.12, height:0.0410, vertical:'center', horizontal: 'right', outlineWidth:0.003, outlineColor:'black'};
	resetSetSymbol();
	//watermark bounds
	...
	loadTextOptions({
		...
		title: {name:'Title', text:'', x:163/2010, y:139/2814, width:1667/2010, height:153/2814, oneLine:true, font:'belerenb', size:0.0386, outlineWidth:0.008, color:'white'},
		type: {name:'Type', text:'', x:172/2010, y:1587/2814, width:1542/2010, height:153/2814, oneLine:true, font:'belerenb', size:0.0323, outlineWidth:0.008, color:'white'},
		rules: {name:'Rules Text', text:'', x:173/2010, y:1775/2814, width:1679/2010, height:810/2814, size:0.0325, lineSpacing: -0.13, outlineWidth:0.008, color:'white', noVerticalCenter:true},
		pt: {name:'Power/Toughness', text:'', x:1668/2010, y:2464/2814, width:246/2010, height:138/2814, size:0.04,  outlineWidth:0.008, font:'belerenbsc', oneLine:true, align:'center', color:'white'}
	});
