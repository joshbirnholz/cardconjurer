...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadTextOptions({
		...
		type: {name:'Type', text:'', x:0.0854, y:0.5664, width:0.8292, height:0.0543, oneLine:true, font:'belerenb', size:0.0324, conditionalColor:'Helper:white'},
		rules: {name:'Rules Text', text:'', x:0.086, y:0.6303, width:0.828, height:0.2875, size:0.0362, conditionalColor:'Helper:white'},
