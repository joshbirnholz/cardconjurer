...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	autoFitArt();
	//set symbol bounds - adjusted for portrait orientation
	card.setSymbolBounds = {x:1242/2010, y:280/2814, width:0.12, height:0.0360, vertical:'center', horizontal: 'center', rotation:-90};
	resetSetSymbol();
	//watermark bounds
