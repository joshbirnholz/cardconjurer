...
var masks = [{src:'/img/frames/saga/nyxflavor/masks/sagaMaskPinline.png', name:'Pinline'}, {src:'/img/frames/saga/nyxflavor/masks/sagaMaskTitle.png', name:'Title'}, {src:'/img/frames/saga/nyxflavor/masks/sagaMaskType.png', name:'Type'}, {src:'/img/frames/saga/nyxflavor/masks/sagaMaskFrame.png', name:'Frame'}, {src:'/img/frames/saga/nyxflavor/masks/sagaMaskBanner.png', name:'Banner'}, {src:'/img/frames/saga/sagaMaskBannerRight.png', name:'Banner (Right)'}, {src:'/img/frames/saga/nyxflavor/masks/sagaMaskText.png', name:'Text'}, {src:'/img/frames/saga/sagaMaskTextRight.png', name:'Text (Right)'}, {src:'/img/frames/saga/nyxflavor/masks/sagaMaskBorder.png', name:'Border'}];
