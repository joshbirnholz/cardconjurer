...
var masks = [{src:'/img/frames/scroll/maskNoOverlay.png', name:'No Art Overlay'}, {src:'/img/frames/scroll/maskBorderlessWithBorder.png', name:'Borderless Overlay'}, {src:'/img/frames/scroll/maskBorderless.png', name:'Fully Borderless Overlay'}];
