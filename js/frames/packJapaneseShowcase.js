...
var masks2 = [{src:'/img/frames/japaneseShowcase/mana/1.png', name:'1 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/2.png', name:'2 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/3.png', name:'3 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/4.png', name:'4 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/5.png', name:'5 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/6.png', name:'6 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/7.png', name:'7 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/8.png', name:'8 Mana Symbol'}, {src:'/img/frames/japaneseShowcase/mana/9.png', name:'9 Mana Symbol'}];
...
availableFrames = [
	...
	{name:'Mana Symbol Backing (10)', src:'/img/frames/japaneseShowcase/mana/10mana.png', masks:masks2, bounds:bounds3},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//text
	loadTextOptions({
		mana: {name:'Mana Cost', text:'', y:0.0683, width:0.9190, height:71/2100, oneLine:true, size:71/1638, align:'right', manaCost:true, manaSpacing:0,},
