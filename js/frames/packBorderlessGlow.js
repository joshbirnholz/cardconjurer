...
availableFrames = [
	{name:'White Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/w.png', masks:masks},
	{name:'Blue Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/u.png', masks:masks},
	{name:'Black Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/b.png', masks:masks},
	{name:'Red Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/r.png', masks:masks},
	{name:'Green Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/g.png', masks:masks},
	{name:'Multicolored Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/m.png', masks:masks},
	{name:'Artifact Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/a.png', masks:masks},
	{name:'Land Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/L.png', masks:masks},
	{name:'Colorless Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/c.png', masks:masks},
	{name:'Black (Alt) Frame Inner Glow', src:'/img/frames/m15/borderless/innerGlow/bAlt.png', masks:masks},
